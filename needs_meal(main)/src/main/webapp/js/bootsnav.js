...
//			$('.list-group a').text($(this)).addClass("active");
//		})
...
//				 $('good-login').show();
//				 $('not-login').attr('display','none');
//			}else{
//					$('good-login').attr('display','none');
//					$('not-login').show();
//				}
//        $('.login-box a').removeAttr('href')
//            $(this).text('김익명님 로그인하셨습니다.')
//       })
//       
...
! function(e) {
	...
	e(document).ready(function() {
		var a = !1;
		t(a), e(document).on("click", ".My-side", function() {
			t(a = !a)
		})
	})
}(jQuery);
