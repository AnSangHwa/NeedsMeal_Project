                    ...
                    <div class="single-product-details">
						...
						<div class="price-box-bar" >
							<div class="cart-and-bay-btn">
								...
								<button type="submit" class="btn hvr-hover go-payitem" style="height:44px; font-weight: bolder; color:white;">구매하기</button>
								<button type="submit" class="btn hvr-hover go-cartadditem" style="height:44px; font-weight: bolder; color:white;">장바구니 담기</button>
							</div>
						</div>
						</form>
			...
			<div id="productReview" class="row my-5" style="display: none;">
				<div class="card card-outline-secondary my-4" >
					...
					<div class="card-body">
						...
						<a href="98_communityList3.do?ctg_id=4000&m_name=${commu.m_name }" class="btn hvr-hover">후기글 전체보기</a>
				  </div>
