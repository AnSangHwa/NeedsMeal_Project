            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" action="loginCheck.do" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                   <label for="id">아이디 </label>
                                    <input type="text" class="form-control" id="id" name="u_id" placeholder="" value="" required>
                                    <div class="invalid-feedback"> 이미 등록된 아이디입니다. 다른 아이디를 입력해 주세요.</div>
                                    <label for="id">비밀번호 </label>
                                    <input type="password" class="form-control" id="password" name="u_pwd" placeholder="" value="" required>
                                    <div class="invalid-feedback"> 이미 등록된 아이디입니다. 다른 아이디를 입력해 주세요.</div>
                                </div>
                                          
                                <div class="col-4 mb-4" style="text-align: center;">
                                    <br>
                                   <button id="submitBtn" class="btn hvr-hover" type="submit" style="width: 100px; height: 110px; color: white;">로그인</button>
                                </div>
